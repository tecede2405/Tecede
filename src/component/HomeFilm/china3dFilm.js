...
import {China3D} from "../../data/dataFilm";

const filmData = China3D;
...
const navigate = useNavigate();
  ...
  return (
    <>
        <div className="mb-1">
            <h2 className="film-category ms-3">Hoạt Hình 3D Trung Của 
              <GoChevronRight 
                onClick={() => navigate("/detail/china3d-film")}
