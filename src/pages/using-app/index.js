            ...
            <div className="using-app">
                ...
                <div className="using-app__main">
                    ...
                    <div className="using-app__main-box">
                        ...
                        <div className="using-app__main-content">
                            <img src="https://res.cloudinary.com/djzeqinsn/image/upload/v1751795780/1751738997818_terjem.jpg" alt="hướng dẫn" loading="lazy" />
                    ...
                    <div className="using-app__main-box">
                        ...
                        <div className="using-app__main-content">
                            <img src="https://res.cloudinary.com/djzeqinsn/image/upload/v1751795780/1751739026152_yarhvm.jpg" alt="hướng dẫn" loading="lazy" />
                    ...
                    <div className="using-app__main-box">
                        ...
                        <div className="using-app__main-content">
                            <img src="https://res.cloudinary.com/djzeqinsn/image/upload/v1751795780/1751739073073_un9yhr.jpg" alt="hướng dẫn" loading="lazy" />
